<h1 class="titre mi-court">Formations</h1>
...
<div id="principal">
	...
	<div class="section-bleu">
		...
		<div class="paragraphe clearfix">
			...
			<p>
				La Formation LaTeX a permis à ceux qui tapaient jusqu'ici leurs rendus et leurs projets sur Microsoft Word de s'initier à cet outil puissant de mise en page. 
			</p>
			<p>
		...
		<div class="paragraphe clearfix">
			...
			<p>
				La Formation Git a attiré beaucoup de curieux, désireux d'apprendre à maîtriser cet outil indispensable pour coder à plusieurs, mais réputé difficile à prendre en main.
			</p>
			<p>
		...
		<div class="paragraphe clearfix">
			<img class="float-right" src="img/accueil/local.jpg"/>
			<p>
				La Formation Web poursuivait deux objectifs : fournir aux élèves les bases nécessaires pour créer un site web de zéro, mais aussi former les futurs développeurs de <a href="upont.php" data-titre="La plateforme uPont - KI">uPont</a>, la plateforme interne des étudiants des Ponts.
			</p>
			<p>
